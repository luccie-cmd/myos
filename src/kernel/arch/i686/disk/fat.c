...
{
    return Disk_ReadSectors(disk, g_Data->BS.BootSector.ReservedSectors + lbaIndex, FAT_CACHE_SIZE, g_Data->FatCache);
}
...
{
    g_Data = (FAT_Data*)syscall_mmap(sizeof(g_Data[0]), 0);
